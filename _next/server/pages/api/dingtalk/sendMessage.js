...
module.exports = __webpack_require__("Jdxn");
...
/* harmony import */ var next_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("KNus");
/* harmony import */ var next_config__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_config__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _api_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("eWHO");
...
const {
  webhook_dingtalk
} = next_config__WEBPACK_IMPORTED_MODULE_0___default()().serverRuntimeConfig;
const config = {
  api: {
    bodyParser: {
      sizeLimit: '1mb'
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    const request = Object(_api_request__WEBPACK_IMPORTED_MODULE_1__[/* createPureRequest */ "a"])({
      baseURL: ''
    });
    const data = req.body.data;
    const apiRes = await request.post(webhook_dingtalk, {
      msgtype: 'text',
      text: _utils_ptbk__WEBPACK_IMPORTED_MODULE_4__[/* ptbk */ "a"].decode(data)
    });
